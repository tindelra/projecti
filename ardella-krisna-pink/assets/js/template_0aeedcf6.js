...
// ----------- COUNTDOWN (Function) ------------------------------------------------------
(function countdown() {
    var event = new Date("2026-03-25T12:30:00+07:00").getTime();
    ...
    function rundown() {
        ...
        $('.count-day').text(days);
        $('.count-hour').text(pad(hours));
        $('.count-minute').text(pad(minutes));
        $('.count-second').text(pad(seconds));
    }
}());
